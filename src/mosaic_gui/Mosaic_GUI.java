...
public class Mosaic_GUI extends javax.swing.JFrame 
    ...
    private void initComponents() {
        ...
        setTitle("Mosaic_GUI V4.0");
        setResizable(false);

        jLabel1.setFont(new java.awt.Font("Tahoma", 3, 11)); // NOI18N
        jLabel1.setText("Version 4.0 - https://github.com/PierreAime/Mosaic_GUI");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) 
            {
            String dir = fc.getSelectedFile() + System.getProperty("file.separator");
            File file=new File(System.getProperty("user.home")+System.getProperty("file.separator")+"thumbnail.png");
			...
			file.createNewFile();
                    ...
                    content = "<body>";
                    bw.write(content + "\r\n");
                    if (lang==1) content = "<h1 style='text-align: center;'>Patron avec Mosaic GUI V4.0</h1>";
                    else if (lang==2) content = "<h1 style='text-align: center;'>Pattern with Mosaic GUI V4.0</h1>";
                    bw.write(content + "\r\n");
